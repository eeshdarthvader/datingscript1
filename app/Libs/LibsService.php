...
class LibsService {
	...
	public function get_settings($key){
		...
		return $this->settingRepo->get_setting($key);
	...
	public function set_settings($key, $value){
		...
		$this->settingRepo->set_setting($key,$value);
	 ...
	 * @param $key
	 */
	public function reset_settings($key){

		$this->settingRepo->reset_setting($key);

	}

	public function make_code($string) {
	...
	public function country_name($code) {
		...
		return $this->country_list[$code];
	}

	public function make_array($lang)
	{
		$out = '<?php '."\nreturn array(\n";
		$out .= self::build_array($lang);
		return $out.');';
	}
