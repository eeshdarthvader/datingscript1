                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>{{$reports->reason}}</td>
                                        <td>
                                        <a href="{{ URL::to('abuse/seen/'.$reports->id) }}"  onclick="return confirm('Are you sure you want to mark this as a Seen Report ?')" style="font-size: 10px;"  type="submit" class="btn btn-info btn-mini">Mark Seen</a>
                                        </td>
                        ...
                        <table id="example2" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>{{$reports->reason}}</td>
                                        <td>
                                        <a href="{{ URL::to('abuse/unseen/'.$reports->id) }}" onclick="return confirm('Are you sure you want to mark this as an Unseen Report ?')" style="font-size: 10px;"  type="submit" class="btn btn-info btn-mini">Mark Unseen</a>
                                        </td>
