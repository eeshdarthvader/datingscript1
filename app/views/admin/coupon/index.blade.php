                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('admin/coupons/createcoupon') }}" method="post"  class="form-horizontal" enctype="multipart/form-data">
                                <br />
...
$(function() {
    ...
    $("#per_user_limit_option").change(function(){
     ...
     $( "#dialog_delete" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('admin/coupons/deletecoupon') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
 ...
 $( "#dialog_enable" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('admin/coupons/enablecoupon') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
                    window.location.reload();
            });
            }
...
$( "#dialog_disable" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('admin/coupons/disablecoupon') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
                    window.location.reload();
            });
            }
