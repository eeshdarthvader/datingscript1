                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('admin/events/createevent') }}" method="post"  class="form-horizontal" enctype="multipart/form-data">
                                <br />
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href="{{ URL::to('admin/events/deleteevent/'.$event->id )}}"s onclick="return confirm('Are you sure you want to delete this event ?')" style="font-size: 10px;"  type="submit" class="btn btn-danger btn-mini">Delete</a>
                                            </td>
