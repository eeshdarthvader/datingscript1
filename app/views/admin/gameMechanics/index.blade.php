                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('admin/gamemechanics/createbot') }}" method="post" id="edit-profile" class="form-horizontal" enctype="multipart/form-data">
                                <br />
                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('admin/gamemechanics/settings') }}" method="post" id="sendmsg" class="form-horizontal">
                                <br />
...
<div id="dialog_password" title="New Password" class="hide">
    <form action="{{URL::to('admin/gamemechanics/newpassword')}}" id="password-form" class="form-horizontal" method="post">
...
$(function() {
    ...
    $( "#dialog_delete" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('/admin/gamemechanics/deletebotblueprint') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
    ...
    $( "#dialog_disable" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('/admin/gamemechanics/disablebotblueprint') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
                    window.location.reload();
            });
            }
    ...
    $( "#dialog_enable" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('/admin/gamemechanics/enablebotblueprint') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
                    window.location.reload();
            });
            }
...
$(".act_sel").change(function(e){
        ...
        $( "#dialog_enable" ).dialog( "open" );
		 		...
		 		var this_url="{{URL::to('/admin/gamemechanics/newpassword')}}";
