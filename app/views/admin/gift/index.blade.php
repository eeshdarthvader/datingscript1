                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('admin/gifts/creategift') }}" method="post"  class="form-horizontal" enctype="multipart/form-data">
                                <br />
                                <div class="control-group">
                                  ...
                                  <div class="control-group">
								    ...
								    <div class="control-group">
                                       <label class="control-label" for="price">For</label>
                                       <div class="controls">
                                            <select class="span4" name="gender">
												<option value="both" selected="selected">All members</option>
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">{{ $gift->gender }}</td>
                                            <td>
...
$(function() {
     ...
     $( "#dialog_delete" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('/admin/gifts/deletegift/') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
