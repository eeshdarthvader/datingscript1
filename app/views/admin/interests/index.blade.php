                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('admin/interests/createcategory') }}" method="post" id="edit-profile" class="form-horizontal">
                                <br />
                            ...
                            <div class="widget widget-nopad">
                                ...
                                <!-- /widget-header -->
                                 ...
                                 <div class="widget-content">
                                   ...
                                   @endif
                                    <form action="{{ URL::to('admin/interests/createinterest') }}" method="post" id="edit-profile" class="form-horizontal">
                                            <br />
                                            <div class="control-group">
...
$(function(){
   ...
   $( "#dialog_delete" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('admin/interests/deletecategory/') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
    ...
    $( "#dialog_delete_interest" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('/admin/interests/deleteinterest/') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
                    window.location.reload();
            });
            }
