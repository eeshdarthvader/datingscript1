            ...
            <!-- /widget-header -->
             ...
             <div class="widget-content">
               ...
               @endif
                ...
                <form action="{{ URL::to('admin/profilefields/addfieldsection') }}" method="post" id="edit-profile" class="form-horizontal">
                        <br />
              ...
              <!-- /widget-header -->
               ...
               <div class="widget-content">
                 ...
                 @endif
                  ...
                  <form action="{{ URL::to('admin/profilefields/addfield') }}" method="post" id="edit-profile" class="form-horizontal">
                          <br />
                          <div class="control-group">
                                      ...
                                      <tr>
                                        ...
                                        @else
                                          ...
                                          <td>
                                            ...
                                            <form action="{{URL::to('admin/profilefields/addfieldoption')}}"  class="form-horizontal" method="post">
...
$(function  () {
  $('.delete_section').click(function(){
    ...
    $.post("{{URL::to('admin/profilefields/deletesection')}}",{ id: section_id}, function(){
      location.reload();
    });
  });
  $('.delete_field').click(function(){
    var field_id = $(this).data('field');
    $.post("{{URL::to('admin/profilefields/deletefield')}}",{ id: field_id}, function(){
      location.reload();
    });
  });
  $('.delete_field_option').click(function(){
    var option_id = $(this).data('option');
    $.post("{{URL::to('admin/profilefields/deletefieldoption')}}",{ id: option_id }, function(){
      location.reload();
    });
  });
});
