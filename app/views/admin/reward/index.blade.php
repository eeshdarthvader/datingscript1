        ...
        <div class="widget widget-nopad">
            ...
            <!-- /widget-header -->
             ...
             <div class="widget-content">
                <form action="{{ URL::to('admin/rewards/updaterewardsettings') }}" method="post" id="edit-profile" class="form-horizontal">
                        <br />
          ...
          <div class="widget widget-table action-table">
            ...
            <div class="widget-content">
              <table class="table table-striped table-bordered">
                ...
                <form action="{{url('admin/rewards/updaterewards')}}"  class="form-horizontal" method="post">
