                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('admin/thirdparty/quickblox') }}" method="post" id="edit-profile" class="form-horizontal">
                                <br />
                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('admin/thirdparty/pandora') }}" method="post" id="edit-profile" class="form-horizontal">
                                <br />
                                <div class="control-group">
