                        ...
                        <table id="example" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($user->online) <td style="color:#00ba8b;">Online </td>@else <td style="color:#dc4539;">Offline</td>@endif
...
<div id="dialog_credits" title="CREDITS" class="hide">
    <form action="{{URL::to('admin/users/credituser')}}" id="credit-form" class="form-horizontal" method="post">
...
<div id="dialog_password" title="New Password" class="hide">
    <form action="{{ URL::to('admin/users/newpassword') }}" id="password-form" class="form-horizontal" method="post">
        <label class="control-label"> </label>
...
$( "#dialog_verify" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('admin/users/verifyuser') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
...
$( "#dialog_offline" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('admin/users/botoffline') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
                    window.location.reload();
            });
            }
...
$( "#dialog_online" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('admin/users/botonline') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
                    window.location.reload();
            });
            }
    ...
    $( "#dialog_disable" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('admin/users/disableuser') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
                    window.location.reload();
            });
            }
    ...
    $( "#dialog_delete" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('admin/users/deleteuser') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
                    window.location.reload();
            });
            }
...
$(".act_sel").change(function(e){
		 	...
		 	if(selected_option == 'offline'){
				...
				$( "#dialog_reset_password" ).dialog( "open" );
		 		...
		 		var this_url="{{URL::to('admin/users/credituser')}}";
                ...
                var this_url="{{URL::to('admin/users/newpassword')}}";
