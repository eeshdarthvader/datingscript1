            ...
            <!-- /widget-header -->
             ...
             <div class="widget-content">
               ...
               @endif
                ...
                <form action="{{ URL::to('app_settings/generals') }}" method="post" id="edit-profile" class="form-horizontal">
                        <br />
                            ...
                            @if(Session::has('successpic')) <div class="alert alert-success">{{ Session::get('successpic') }}</div> @endif
                                <div class="shortcuts">
                                        ...
                                        <img src="{{URL::to('/uploads/app/'.$sitelogourl )}}" width="200px"  /> <br>
                                         <a type="submit" onclick="return confirm('Are you sure you want to delete the logo ?')"  href="{{ URL::to('app_settings/deletelogo') }}" class="btn btn-danger">Delete Photo</a>
                                </div>
                            @endif

                               <form id="edit-profile" class="form-horizontal" action="{{ URL::to('app_settings/uploadlogo') }}" method="post" enctype="multipart/form-data">
                                       <br />
                                       <div class="control-group">
                                           <div class="controls">
                            ...
                            @if(Session::has('successfav')) <div class="alert alert-success">{{ Session::get('successfav') }}</div> @endif
                                <div class="shortcuts">
                                        ...
                                        <img src="{{URL::to('/uploads/app/'.$sitefaviconurl )}}" width="200px"  /> <br>
                                         <a type="submit" onclick="return confirm('Are you sure you want to delete the favicon?')"  href="{{ URL::to('app_settings/deletefavicon') }}" class="btn btn-danger">Delete Photo</a>
                                </div>
                            @endif

                               <form id="edit-profile" class="form-horizontal" action="{{ URL::to('app_settings/uploadfavicon') }}" method="post" enctype="multipart/form-data">
                                       <br />
                                       <div class="control-group">
                                           <div class="controls">
