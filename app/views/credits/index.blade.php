                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('credits/addpackage') }}" method="post" id="edit-profile" class="form-horizontal">
                                <br />
                                ...
                                <!-- /widget-header -->
                                 ...
                                 <div class="widget-content">
                                   ...
                                   @endif
                                    ...
                                    <form action="{{ URL::to('credits/creditall') }}" method="post" id="edit-profile" class="form-horizontal">
                                            <br />
                                            <div class="control-group">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        ...
                        <form action="{{ URL::to('credits/updategeneral') }}" method="post" id="edit-profile" class="form-horizontal">
                                <br />
                                <div class="control-group">
...
$(function() {
     ...
     $( "#dialog_delete" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('/credits/deletepackage/') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
