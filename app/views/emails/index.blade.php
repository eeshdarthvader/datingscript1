                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('emails/updateemailconfig') }}" method="post" id="edit-profile" class="form-horizontal">
                                <br />
                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                        ...
                        @endif
                        <form action="{{ URL::to('emails/updateemailnotification') }}" method="post" id="edit-profile" class="form-horizontal">
                                <br />
