...
<div class="intro-page">
	<header>
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<div class="intro-logo"><a href="index.html"><img class="img-responsive" src="{{URL::to('/uploads/app/'.$logo)}}" alt="..." style="height: 20px;width: 90px;"></a></div>
				...
				<div class="col-sm-6">
					<div class="already-member">
						<ul>
							<li class="member"><a href="{{URL::to('/login')}}">Already a member?</a></li>
							<li class="sign"><a href="{{URL::to('/login')}}">Sign In</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="col-sm-5 col-sm-offset-1">
						<div class="sign-up">
							...
							<div class="row">
								...
								<div class="col-xs-8">
									<select id="hereto" class="selectpicker form-control" title="hereto" name="here_to">
										<option value="make_friends">Make New Firends</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-1 vmiddle">
                                    <a data-toggle="tooltip" data-placement="bottom" data-animation="true" class="glyphicon glyphicon-question-sign vcenter white-tooltip"></a>
                                </div>
                                
                                <div class="col-xs-8">
                                    <input type="password" class="form-control" id="nominator" name="nominator">
                                </div>
                            </div>
	...
	<div class="container-fluid connect-mian-bg">
	  <div class="row">
	    <div class="col-sm-7 contect-bg">
		 ...
		 <p>{{$title}} can be connected with all kinds of 
equipments as computer, tablet, mobile and 
cellular phones. You can connect
anytime and anywhere to {{$title}} and
	    ...
	    <div class="row">
		  ...
		  <div class="col-sm-6">
		    <div class="nearby-mem-box">
			  ...
			  <p>{{$title}} never open your exact location for 
				your privacy.<br>
