                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        ...
                        <form action="{{ URL::to('multilanguage/settings') }}" method="post" id="sendmsg" class="form-horizontal">
                                <br />
        ...
        <div class="span12">
            ...
            <div class="widget ">
                ...
                <div class="widget-content">
					...
					<form action="{{URL::to('/multilanguage/userlanguages')}}" id="form-general" class="form-horizontal" method="post">
							...
							<tbody>
								@foreach($all_languages as $k => $v)
									<tr>
										...
										<td><a href="{{ url('multilanguage/edit/'.$k) }}">Edit Vocabulary</a></td>
									</tr>
								@endforeach
