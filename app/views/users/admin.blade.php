                ...
                <div class="widget widget-nopad">
                    ...
                    <!-- /widget-header -->
                     ...
                     <div class="widget-content">
                       ...
                       @endif
                        <form action="{{ URL::to('admin/create') }}" method="post" id="edit-profile" class="form-horizontal">
                                <br />
...
<div id="dialog_password" title="New Password" class="hide">
    <form action="{{URL::to('/admin/newpassword')}}" id="password-form" class="form-horizontal" method="post">
...
$(document).ready(function() {
    ...
    $( "#dialog_delete" ).dialog({
        ...
        buttons: [
        {
            ...
            click: function() {
            var self = this;
                $.post("{{ URL::to('/admin/deleteuser') }}",{'id' : $(this).data('id')},function() {
                    $(self).dialog( "close" );
...
$(".act_sel").change(function(e){
		 	...
		 	if(selected_option == 'delete'){
				...
				$( "#dialog_delete" ).dialog( "open" );
		 		...
		 		var this_url="{{URL::to('/admin/newpassword')}}";
